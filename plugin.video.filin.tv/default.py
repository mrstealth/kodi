...
def search():
    ...
    search_url = "http://filin.tv/index.php?do=search"
...
def showItem(url, thumbnail):
    ...
    playlist_url = common.parseDOM(content, "input", attrs = { 'name':'pl' }, ret="value")[0]

    if playlist_url:
        response = common.fetchPage({"link": playlist_url})["content"]
